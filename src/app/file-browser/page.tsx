    ...
    <div className='min-h-[calc(100vh-87px)] bg-zinc-100 px-15 py-15'>
      <div className='max-w-[700px] min-w-[300px] rounded-xl border-2 border-gray-300 bg-gray-200 shadow-xl'>
        ...
        <div className='flex space-x-5 border-b-2 border-gray-200 bg-gray-100 p-2'>
          ...
          <input
            type='textfield'
            className='flex-1 rounded bg-white p-2 text-sm text-gray-700 ring-0 outline-gray-200 placeholder:text-gray-400'
            placeholder=''
            defaultValue={''}
          />
          {/* <Breadcrumbs path='' /> */}
        </div>
        <div className='h-[300px] resize overflow-y-scroll rounded-br-xl rounded-bl-xl bg-white p-5'>
